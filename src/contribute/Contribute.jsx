        ...
        <>
            <div className="fontsm flex h-screen flex-row">
                ...
                <div className="sborder1 flex basis-7/12 flex-col">
                    ...
                    <div className="flex basis-7/12 flex-col items-center justify-center gap-8">
                ...
                <div className="flex basis-1/4 flex-col">
                    <div className="sborder2 flex basis-1/3 flex-col items-center justify-center">
                        <div className="hoverable"></div>
                        <div className="text-[#D9D9D950] transition-all duration-500 hover:text-[#D9D9D9]">[ADD THE TITLE/]</div>
                    </div>
                    <div className="sborder2 flex basis-1/2 flex-col items-center justify-center">
                        <div className="hoverable"></div>
