        ...
        <>
            <div className="fontsm flex h-screen flex-row" id="login">
                <div className="flex basis-2/12 flex-col">
                    <Link to="/" className="hoverable sborder2 flex basis-2/6 items-center justify-center bg-[#D9D9D9] hover:cursor-none">
                ...
                <div className="flex basis-2/12 flex-col">
                    <div className="sborder2 hoverable flex basis-5/12 flex-col">
                        <div className="sborder2 flex basis-2/3 items-end justify-center px-12 pb-12 text-[#D9D9D950] hover:text-[#D9D9D9] transition-all duration-500">DON'T HAVE AN ACCOUNT?</div>
                        <Link to="/signup" className="flex basis-1/3 items-center justify-center text-[#D9D9D950] hover:bg-[#d9d9d9] hover:text-[#060B19] transition-all duration-500">SIGN UP</Link>
                    </div>
