    ...
    <>
      <div className="fontsm new3 flex max-sm:flex-col" id="about">
        ...
        <div className="flex basis-1/3 flex-col">
          <div className="new2 flex basis-5/6 items-center justify-center sm:p-20 p-8 text-[#D9D9D950]">
          ...
          <Link
            to="/signup"
            className="flex hoverable sm:basis-1/6 items-center max-sm:h-20 justify-center cursor-none bg-[#D9D9D9] text-[#D060B19]"
          >
            JOIN US NOW
          </Link>
        </div>
