    ...
    return(
        <>
            <div className="fontsm flex-rows flex h-28" id="home">
                ...
                <Link to="contribute" className="custom2 flex basis-1/6 items-center justify-center text-[#D9D9D950] hover:text-[#d9d9d9] transition-all duration-100">ADD+</Link>
                <Link to="signup" className="custom1 new2 hoverable flex basis-1/6 items-center justify-center text-white hover:bg-[#d9d9d9] hover:text-[#060B19] hover:cursor-none transition-all duration-500">SIGN UP</Link>
            </div>
        </>
    );
}