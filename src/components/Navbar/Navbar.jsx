    ...
    return(
        <>
            <div className="fontsm flex-rows flex h-24">
                <div className="custom2 hoverable flex basis-1/6 items-center justify-center bg-[#d9d9d9] hover:bg-[#060B19] transition-all duration-500"><img src="assets/logo.svg" width="25rem"></img></div>
