        ...
        <>
            <div className="fontsm unique2 flex flex-row">
                ...
                <div className="flex basis-1/3 flex-col bg-[url('/assets/main.png')]">
                    ...
                    <a href="contribute" className="unique1 flex basis-1/3 items-center justify-center bg-[#D9D9D980] text-[#D060B19] hover:bg-[#D9D9D9] transition-all duration-500">CONTRIBUTE</a>
                    <a href="auth" className="unique1 hoverable flex basis-1/3 items-center justify-center bg-[#D9D9D9] text-[#D060B19] hover:cursor-none">JOIN US NOW</a>
                </div>
            </div>
        </>
    );
