        ...
        <>
            <div className="fontsm unique2 flex flex-row">
                <div className="new1 flex basis-2/3 flex-col justify-center gap-4 pl-20 pr-96">
                    ...
                    <div className="hoverable text-[#D9D9D950] hover:text-[#D9D9D9] transition-all duration-500">SOMETIMES IT’S JUST OUR FEELINGS THAT GET INVOLVED IN BETWEEN OUR HEART AND MIND, AND WE CAN’T TAKE THE DECISION WHICH IS RIGHT FOR US.</div>
                </div>
