        ...
        >
          <div className="sm:border-r-2 sm:border-l-2 border-[#FFFFFF15] flex col-span-4 flex-col">
            <div className="flex basis-5/12 items-end sm:pb-16 max-sm:pt-24 pb-10 sm:pl-20 pl-8">
              <p className="fontlg hoverable text-6xl 2xl:text-8xl text-white">Sign Up</p>
            </div>
            <div className="flex flex-col justify-center gap-8 2xl:gap-12 basis-7/12 bg-[#D9D9D9] sm:pl-20 sm:pr-64 max-sm:py-10 px-8 text-[#060B1990]">
              <input
                required
                type="text"
                name="name"
