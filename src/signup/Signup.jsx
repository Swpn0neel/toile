            ...
            <div className="fontsm flex h-screen flex-row" id="signup">
                ...
                <div className="flex basis-2/12 flex-col">
                    <div className="sborder2 hoverable flex basis-5/12 flex-col">
                        ...
                        <Link to="/signin" className="flex basis-1/3 items-center justify-center text-[#D9D9D950] hover:bg-[#d9d9d9] hover:text-[#060B19] transition-all duration-500">SIGN IN</Link>
                    </div>
